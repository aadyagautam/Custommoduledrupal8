...
namespace Drupal\add_form\Form;
 ...
 * Class AddformForm.
 *
 * @package Drupal\add_form\Form
 */
class AddformForm extends FormBase {
/**
 * {@inheritdoc}
 */
 public function getFormId() {
 return 'add_form_form';
 }
/**
 * {@inheritdoc}
 */
 ...
 */
 ...
 $query->update('add_form')
 ->fields($field)
 ->condition('id', $_GET['num'])
 ->execute();
 drupal_set_message("succesfully updated");
 $form_state->setRedirect('add_form.display_table_controller_display');
 }
 else
 {
 $field = array(
 ...
 $query = \Drupal::database();
 $query ->insert('add_form')
 ->fields($field)
 ->execute();
 drupal_set_message("succesfully saved");
 $response = new RedirectResponse("/add_form/hello/table");
 $response->send();
 }
 }
}